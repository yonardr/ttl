<template>
  ...
  <header class="scroll">
     ...
     <div class="contacts">
       <a href="tel:88432407717" style="text-decoration: none">
       <div class="phone">
         8 (843) 240-77-17
       </div>
       </a>
       <div>
         <a href="tel:88432407717" style="text-decoration: none">
         <BlueButton>Позвонить</BlueButton>
         </a>
       </div>
     </div>
      ...
      <div class="burger" :class="{active: burger_active}" @click="burger_active=!burger_active"><span></span>
      </div>
